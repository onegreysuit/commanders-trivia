export default function ResultScreen({ score, total, categoryStats, onReplay, onHome, onLeaderboard }) {
  ...
  const getMessage = () => {
    if (pct === 100) return "Perfect! Hail to you — true Burgundy & Gold!";
    if (pct >= 80) return "Impressive! You know your Washington football!";
    if (pct >= 60) return "Solid! You know your Commanders history.";
    if (pct >= 40) return "Not bad — time to review the playbook.";
    return "Rookie numbers! Hit the Commanders archives and try again.";
  };
